// Work list gadget with show results dropdown Test Cases from AMI-2038:45
...
describe("Working List Gadget with Show Results DropDown", function() {
    ...
    before("Adding log header", function() {
        ...
        cy.logHeader("Working List Gadget with Show Results DropDown");
    
    });
    
    /*  1.Create object say, O1 under structure S1. 
        2.Select Object IDs in 'List elements as' field. 
        3.Set the id of O1 in 'List of Objects' field. 
        4.Select Add and click Apply button.
    */

    it("AMI-2038:45, O1 Should get linked with the list object.", function() {
        
        cy.start('AMI-2038:45');
